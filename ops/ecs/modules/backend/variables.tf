variable image {
  ...
  default = "615677714887.dkr.ecr.eu-central-1.amazonaws.com/ecs-web-application-demo-backend-repo"
}

variable "ecr_arn" {
  type = string
  description = "The ARN of the ECR repository."
  default = "arn:aws:ecr:eu-central-1:615677714887:repository/ecs-web-application-demo-backend-repo"
}
